    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 col-xs-12">
                <h3>HARDCO GROUP</h3>
                <hr class="line_mission" align="left">
                <p>Established in 1976, HARDCO has gained over 35 years of experience contributing to our potential growth
...
<section class="our_mission_text">
    <div class="container">
        <div class="row">
            <h4>OUR MISSION</h4>
            <hr>
            <p>HARDCO's philosophy has remained unchanged for over three decades: Quality services Delivered On-time and On-budget. To that end, our mission is:</p>
            <ul>
...
<section class="big_cover_mission2 container-fluid no_padding">
...
<section class="testimonial_seciton_mission">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <img src="img/mission_testimonial-01.png">
            </div>
            <div class="col-md-7">
                <h3>Aref Derbas</h3>
                <span>CEO,HARDCO</span>
                <p>The HARDCO group has been built by a combination of effective conversion of opportunities, organic growth of our diverse businesses and by successfully providing quality services on turnkey projects. <br>
                ...
                <p>We are proud of our workforce which has continued to offer their uncompromising services and informed expertise in structural and specialized steel works, on-shore and offshore building, finishing works, tensile architectural solutions and a gamut of industrial constructions and operations. <br>
                ...
                <p>At HARDCO, quality is always a prerequisite and client satisfaction is expected.
