...
<section class="testimonil_text_section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 text-testimonials wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">
                <h4 class=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s">Architect Awards 2016</h4>
                <h5 class=" wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">Hardco Engineering Co.</h5>
